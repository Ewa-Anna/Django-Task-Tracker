...
from .views import DictionaryContentView, ProjectDeleteView, ProjectOwnerList, ProjectAssigneeList
...
urlpatterns = [
    ...
    path("list_of_prj_assignee/", ProjectAssigneeList.as_view(), name="project-assignee-list"),
    path(
