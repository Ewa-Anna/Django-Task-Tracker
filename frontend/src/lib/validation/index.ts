...
export const ProfileFormValidationSchema = z.object({
  first_name: z.string().min(3, { message: "Name should be atleast 3 characters long" }),
  last_name: z.string().min(3, { message: "Lastname should be atleast 3 characters long" }),
  bio: z.string().min(10, { message: "Your bio should containt atleast 10 characters" }).max(200, { message: "Maximum amount characters is set to 200" })
})