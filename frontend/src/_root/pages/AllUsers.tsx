...
const {data:users,isError,isLoading,isFetching}= useQuery("recipes",()=>getUsers())
...
{users&&users.map((user)=>{
  return(
    ...
    <img    src={user.userAvatar||"/assets/icons/profile-placeholder.svg"} alt="avatar" className="rounded-full w-14 h-14" />
      <div>
    ...
    <CardFooter className="flex justify-between">
      <Button className="hover:bg-purple-700" variant="ghost">View more</Button>
