...
const ProjectFormStepFour = ({
  ...
  return (
    <div
      className={cn(" flex-col lg:flex-col", {
        hidden:
          currentStep === 0 ||
          currentStep === 1 ||
          currentStep === 2 ||
    ...
    >
      <div className="w-full min-h-[500px]  flex justify-between overflow-hidden flex-col lg:flex-row">
        <div className="px-6 py-4 border-2 border-dark-4 flex flex-col justify-start  gap-10 min-h-[250px] min-w-[200px] flex-1 overflow-y-scroll custom-scrollbar">
          {users &&
            users?.results
     ...
     {errors.assignees && <span>{errors.assignees.message}</span>}
     </div>
    </div>
  );
};
